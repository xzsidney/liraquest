...
trigger1 = random <= 700 && stateno = 242 && animelemtime(1) > 3  && enemy, gethitvar(fall) = 0 && movehit
trigger2 = random <= 700 && stateno = 460 && animelemtime(2) > 0 && movehit
...
trigger1 = statetype != A && ctrl
trigger1 = p2statetype != A && ifelse(p2movetype = A, random <= 700,random <= 300) 
trigger1 = p2bodydist x > 120 && p2movetype != H
trigger2 = statetype != A && ctrl
trigger2 = (p2stateno = [100,106]) && random <= 300
trigger3 = var(19) <= 0 && random <= 500 && stateno = 242 && animelemtime(1) > 3  && enemy, gethitvar(fall) = 0
...
triggerall = var(9) = 1
triggerall = power >= 1000 
trigger1 = stateno = 440 && animelemtime(7) > 1 && movehit && random <= 200 
trigger2 = p2movetype = A && p2statetype != A && ctrl && statetype != A && random <= 300 
...
trigger3 = statetype != A && ctrl && p2bodydist x > 120 && random <= 500 && enemynear, movetype != A
trigger4 = random <= 500 && stateno = 440 && animelemtime(7) > 0 && moveguarded
...
triggerall = var(9) = 1
triggerall = pos y <= -92
trigger1 = statetype = A && ctrl && stateno != 672 && (p2bodydist x = [45,80]) 
...
trigger3 = stateno = 680 && animelemtime(2) > 0 && movecontact 
trigger4 = stateno = 681 && animelemtime(2) > 0 && movecontact
