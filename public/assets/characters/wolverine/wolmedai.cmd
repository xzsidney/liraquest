...
trigger1 = random <= 500 && p2bodydist Y < 25 && p2statetype = A && pos Y < -25 
trigger2 = random <= 500 && p2bodydist Y <= 70 && p2statetype != A 

[State -1,JLK]
type = ChangeState
value = 610
triggerall = var(9) = 1
trigger1 = stateno = 600 && animelemtime(2) > 0 && movecontact && p2bodydist x <= 50 && random <= 500

[State -1,JMP]
type = ChangeState
value = 620
triggerall = var(9) = 1
trigger1 = stateno = 610 && animelemtime(2) > 0 && movecontact && p2bodydist x <= 50 && random <= 500

[State -1,JDHKMVC]
type = ChangeState
value = 670
triggerall = var(9) = 1
trigger1 = pos y <= -92 && random <= 500 && var(15) <= 0 && random <= 500
...
trigger1 = statetype = A && ctrl && stateno != 672 && (p2bodydist x = [40,80]) 
trigger1 = random <= 100 && var(15) <= 0
trigger2 = stateno = 630 && animelemtime(3) > 0 && movecontact && p2bodydist y <= 80 && var(15) <= 0

[State -1,JMK]
type = ChangeState
value = 640
triggerall = var(9) = 1
trigger1 = stateno = 630 && animelemtime(3) > 0 && movecontact && random <= 500 && p2bodydist x <= 50

[State -1,JHP]
type = ChangeState
value = 650
triggerall = var(9) = 1
trigger1 = statetype = A && ctrl && random <= 500 && p2bodydist Y <= 70 && p2statetype != A && p2bodydist x <= 40 && vel y > 0
trigger2 = stateno = 640 && animelemtime(3) > 0 && movecontact && random <= 500 
trigger3 = stateno = 680 && animelemtime(2) > 0 && movecontact && random <= 500 
trigger4 = stateno = 681 && animelemtime(2) > 0 && movecontact && random <= 500 

[State -1,JHK]
type = ChangeState
value = 660
triggerall = var(9) = 1
trigger1 = stateno = 650 && animelemtime(2) > 0 && movecontact && random <= 500 
trigger2 = stateno = 670 && animelemtime(2) > 0 && movecontact && random <= 500 
trigger3 = stateno = 671 && animelemtime(2) > 0 && movecontact && random <= 500 
...
trigger4 = stateno = 680 && animelemtime(2) > 0 && p2stateno > 1000 && p2name = "cvsgeese"
trigger5 = stateno = 681 && animelemtime(2) > 0 && p2stateno > 1000 && p2name = "cvsgeese"
...
trigger4 = stateno = 680 && animelemtime(2) > 0 && moveguarded
trigger5 = stateno = 681 && animelemtime(2) > 0 && moveguarded
...
trigger1 = statetype = S && ctrl && p2movetype != A
...
trigger1 = p2statetype = S && statetype != A && ctrl
...
[State -1, BERKS/1337 X]
type = ChangeState
value = ifelse(random <= 700, 6000, 6600)
triggerall = var(9) = 1
...
trigger7 = stateno = 235 && animelemtime(1) > 0
trigger8 = stateno = 240 && animelemtime(4) > 0 
trigger9 = stateno = 242 && animelemtime(1) > 3
trigger10 = stateno = 250 && animelemtime(3) > 0
trigger11 = stateno = 400 && animelemtime(3) > 0 
trigger12 = stateno = 410 && animelemtime(2) > 0 
trigger13 = stateno = 420 && animelemtime(4) > 0 
trigger14 = stateno = 430 && animelemtime(3) > 0 
trigger15 = stateno = 440 && animelemtime(7) > 0
trigger16 = stateno = 450 && animelemtime(5) > 0
trigger17 = stateno = 460 && animelemtime(2) > 0
ignorehitpause = 1
var(39) = var(39) | 1
...
trigger3 = stateno = 620 && animelemtime(3) > 0 
trigger4 = stateno = 630 && animelemtime(3) > 0 
trigger5 = stateno = 640 && animelemtime(3) > 0 
trigger6 = stateno = 650 && animelemtime(2) > 0 
trigger7 = stateno = 670 && animelemtime(2) > 0 
trigger8 = stateno = 671 && animelemtime(2) > 0 
trigger9 = stateno = 680 && animelemtime(2) > 0 
trigger10 = stateno = 681 && animelemtime(2) > 0
trigger11 = stateno = 660 && animelemtime(2) > 0
ignorehitpause = 1
var(14) = var(14) | 1
...
value = 6600
;triggerall = var(9) != 1
triggerall = command = "1337" && power >= 1000
...
[State -1, Healin Factor X]
type = ChangeState
value = 6200
;triggerall = var(9) != 1
triggerall = command = "heal" && power >= 1000 && life < 999
trigger1 = statetype != A && ctrl 
trigger2 = var(39) = 1
...
triggerall = (stateno != [2300,2400]) && var(15) <= 0
trigger1 = statetype = A && ctrl 
trigger2 = var(14) = 1
...
trigger1 = stateno = 250 && animelemtime(3) > 0 && movecontact && var(10) <= 0
trigger2 = command = "longjump" && ifelse(stateno = 250, var(10)<=0, 1)
trigger2 = statetype != A && (ctrl || (var(39) = 1 && movecontact))
...
type = ChangeState
triggerall = Command = "recovery"
trigger1 = Vel Y > 0 && Pos Y >= -20 && alive && CanRecover && statetype = A
value = 5200
;=============================================================================
;-------------[Throws]------------------------
;=============================================================================
...
trigger5 = stateno = 630 && animelemtime(3) > 0 && movecontact
trigger6 = stateno = 640 && animelemtime(3) > 0 && movecontact
trigger7 = stateno = 680 && animelemtime(2) > 0 && movecontact
trigger8 = stateno = 681 && animelemtime(2) > 0 && movecontact
...
trigger5 = stateno = 630 && animelemtime(3) > 0 && movecontact
trigger6 = stateno = 640 && animelemtime(3) > 0 && movecontact
trigger7 = stateno = 650 && animelemtime(2) > 0 && movecontact
trigger8 = stateno = 670 && animelemtime(2) > 0 && movecontact && command != "holddown"
trigger9 = stateno = 671 && animelemtime(2) > 0 && movecontact && command != "holddown"
trigger10 = stateno = 680 && animelemtime(2) > 0 && movecontact && command != "holddown"
trigger11 = stateno = 681 && animelemtime(2) > 0 && movecontact && command != "holddown"
