...
| `GET` | `/api/family/analytics` | JWT (`PARENT` / `ADMIN`) | Retorna métricas do Painel do Clã (membros online em tempo real, Top Herói que mais fez tarefas, Herói em foco e totais do clã) |
