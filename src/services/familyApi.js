...
export const familyApi = {
    ...
    async claimCharacter(characterId) {
    ...
    async updateCharacterStats(characterId, attribute) {
    ...
    async updateCharacterAvatar(characterId, avatarUrl) {
    ...
    async recoverFromInfirmary(characterId, force) {
    ...
    async getSkillTree(characterId) {
    ...
    async buySkill(characterId, skillId) {
    ...
    async equipSkill(characterId, skillId, equip) {
